                      ...
                      <article class="article">
                        ...
                        <div class="article__info">
                          ...
                          <div class="article__info__meta">
                            ...
                            ?>
                            <small>Категория: <a href="/articles.php?categorie_id=<?php echo $art_cat['id']; ?>"><?php echo $art_cat['title'];?></a></small>
                          </div>
                          <div class="article__info__preview"><?php echo mb_substr(strip_tags($art['text']), 0, 100, 'utf-8').' ...'; ?></div>
                        </div>
                      </article>
                  ...
                  <?php 
                    while($art = mysqli_fetch_assoc($articles))
                    {
                      ...
                      <article class="article">
                        <div class="article__image" style="background-image: url(/static/images/<?php echo $art['image']; ?>);"></div>
                        <div class="article__info">
                          <a href="/article.php?categorie_id=<?php echo $art['id'];?>"><?php echo $art['title'];?></a>
                          <div class="article__info__meta">
                            <?php
                            $art_cat = false;
                            foreach($categories as $cat)
